...
public class AppartementController {
    ...
    public ResponseEntity<AppartementDto> save(@RequestBody AppartementDto dto) {
    ...
    @GetMapping("/all")
    public ResponseEntity<List<AppartementDto>> findAll() {
    ...
    public ResponseEntity<AppartementDto> findByID(@PathVariable("id") Long id) {
    ...
    public ResponseEntity<AppartementDto> findByName(@PathVariable("name") String name) {
    ...
    public ResponseEntity<List<AppartementDto>> findByIdPays(@PathVariable("id") Long id) {
