...
public class EncaissementPrincipalServiceImpl
  ...
  public boolean saveEncaissement(EncaissementPayloadDto dto) {
    ...
    List<AppelLoyersFactureDto> listAppelImpayerParBail = appelLoyerService.findAllAppelLoyerImpayerByBailId(
      bailLocation.getId()
    );
    ...
    for (AppelLoyersFactureDto appelLoyerDto : listAppelImpayerParBail) {
      ...
      if (montantVerser >= appelLoyerDto.getSoldeAppelLoyer()) {
        ...
        double montantAPayerLeMois =
          appelLoyerDto.getNouveauMontantLoyer() -
        ...
        appelLoyerRepository.save(
          gestimoWebMapper.fromAppelLoyerDto(appelLoyerDto)
        );
        AppelLoyersFactureDto appelLoyersFactureDto = appelLoyerService.getFirstLoyerImpayerByBien(
          appelLoyerDto.getIdBailLocation()
        );
        appelLoyersFactureDto.setUnLock(true);
        AppelLoyer unlockAppelLoyer = appelLoyerRepository
          .findById(appelLoyersFactureDto.getId())
          .orElse(null);
  ...
  public List<EncaissementPrincipalDTO> saveEncaissementAvecRetourDeList(
    ...
    log.info(
      "BAIL A ENREGISTRER {} et la liste des appels impayés est {}",
      bailLocation.getId(),
    ...
    for (AppelLoyersFactureDto appelLoyerDto : listAppelImpayerParBail) {
      log.info(
        ...
        appelLoyerDto.getMontantLoyerBailLPeriode(),
        montantVerser,
