    ...
    public MontantLoyerBailDto saveNewMontantLoyerBail(MontantLoyerBailDto dto) {
        ...
        if (byBailLocation.size()==0){
            ...
            if( dto.getAncienMontantLoyer()!=0 ){
                dto.setTauxLoyer((dto.getNouveauMontantLoyer()- dto.getAncienMontantLoyer())*100/ dto.getAncienMontantLoyer());
            }
            dto.setMontantAugmentation((dto.getNouveauMontantLoyer()- dto.getAncienMontantLoyer()));
            dto.setDebutLoyer(bailLocation.getDateDebut());
        }
        ...
        if(shoulddoUpdate){
            //TODO
            //UPDATE THE PREVIOUS PRICE SET IT THE FALSE IN STATUS FIELD AND PROVIDE THE END DATE
            log.info("cool");
        }
