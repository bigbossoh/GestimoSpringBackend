...
public class UtilisateurServiceImpl implements UtilisateurService {
  ...
  public UtilisateurAfficheDto saveUtilisateur(UtilisateurRequestDto dto) {
    if (dto.getId() == 0 || dto.getId() == null) {
      ...
      EtablissementUtilisateur etablissementUtilisateur;
      ...
      Role leRole = roleRepository
        .findRoleByRoleName(dto.getRoleUsed())
        .orElseThrow(() ->
          new InvalidEntityException(
  ...
  public List<UtilisateurAfficheDto> listOfAllUtilisateurClientHotelOrderbyNameByAgence(
    ...
    return utilisateurRepository
      ...
      .filter(agence ->
        ...
        agence.getUrole().getRoleName().equals("CLIENT HOTEL") &&
        !agence.getUsername().contains("1234567890")
      )
      .sorted(Comparator.comparing(Utilisateur::getNom))
      .map(gestimoWebMapperImpl::fromUtilisateur)
      .collect(Collectors.toList());
